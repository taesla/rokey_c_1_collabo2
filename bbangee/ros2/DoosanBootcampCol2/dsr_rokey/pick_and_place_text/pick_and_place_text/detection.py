...
class ObjectDetectionNode(Node):
    ...
    def publish_detection_image(self):
        ...
        # OpenCV 창에도 표시
        cv2.imshow('Detection (실시간)', annotated_frame)
        cv2.waitKey(1)
    ...
    def _compute_position(self, target):
        ...
        box, score, annotated_frame = self.model.get_best_detection_with_viz(self.img_node, target)
        
        # Detection Result 창 제거 (RViz 토픽으로만 확인)
